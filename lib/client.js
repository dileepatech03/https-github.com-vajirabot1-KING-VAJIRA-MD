...
try {
    ...
    console.log("🌍 Connected to the VAJIRA  BOT")
} catch {
 ...
 Void.ev.on('group-participants.update', async(anu) => {
        ...
        Void.ev.on('connection.update', async(update) => {
                ...
                if (connection === 'open') {
                    ...
                    console.log("😁  Vajira External Plugins Installed!");fs.readdirSync(__dirname + "/../src").forEach((plugin) => {
