...
if (fs.existsSync('./LANG/' + Config.LANG + '.json')) {	
	...
	var json = JSON.parse(fs.readFileSync('./LANG/VAJIRA.json'));	
}	
...
let fname = await huh.writeFileSync(__dirname+'/../plugin/System/1.js', data, "utf8")
console.log('fname '+fname)
const command = require(__dirname+'/../plugin/System/1.js', data, "utf8");
